...
namespace Tires
{
    ...
    public partial class TiresEntities : DbContext
    {
        public TiresEntities()
            : base("name=TiresEntities")
        {
        }

        private static TiresEntities _context;

        public static TiresEntities GetContext()
        {
            if (_context == null)
                _context = new TiresEntities();
            return _context;
        }
